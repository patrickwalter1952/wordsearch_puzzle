...
import 'package:wordsearch_puzzle/wordsearch_lib/skip_orientations.dart';
import 'package:wordsearch_puzzle/wordsearch_lib/utils.dart';
...
class WordSearch {
  ...
  WSNewPuzzle newPuzzle(
    ...
    WSNewPuzzle output = WSNewPuzzle(puzzle: [], wordsNotPlaced: [], warnings: [], errors: []);
    if (words.isEmpty) {
